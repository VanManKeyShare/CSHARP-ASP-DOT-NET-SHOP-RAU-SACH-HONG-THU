<%@ Page Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
 CodeBehind="DanhMuc.aspx.cs" Inherits="RAU_SACH_HONG_THU.DanhMuc" %>
    ...
    <asp:Panel ID="panel_them_sua" runat="server" Visible="false">
        <div class="panel-body">
		    ...
		    <table style="width: 100%;" class="vmk_table_form">
                <tr>
                    <td style="width: 110px; white-space: nowrap">TÊN DANH MỤC</td>
                    <td><asp:TextBox ID="txt_tendm" runat="server" MaxLength="50" Width="100%"></asp:TextBox></td>
                </tr>
            </table>
        </div>
    </asp:Panel>
