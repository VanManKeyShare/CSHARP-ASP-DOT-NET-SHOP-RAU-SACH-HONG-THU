...
namespace RAU_SACH_HONG_THU
{
    public partial class DonHangChiTiet : System.Web.UI.Page
    {
        ...
        public string Xu_Ly_Gioi_Tinh(object gioi_tinh)
        {
            return ClassMain.Xu_Ly_Gioi_Tinh(gioi_tinh);
        }

        public string Xu_Ly_Ngay_Thang_Nam(object ngay, object thang, object nam)
        {
            return ClassMain.Xu_Ly_Ngay_Thang_Nam(ngay, thang, nam);
        }
        ...
        {
            this.Page.Title = "XEM CHI TIẾT ĐƠN HÀNG";
