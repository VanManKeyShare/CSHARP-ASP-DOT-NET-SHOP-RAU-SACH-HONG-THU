<%@ Page Language="C#" AutoEventWireup="true"
 CodeBehind="DangNhap.aspx.cs" Inherits="RAU_SACH_HONG_THU.DangNhap" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head runat="server">

    <title>CỬA HÀNG RAU SẠCH HỒNG THU</title>

    <meta charset="utf-8"/>
	<meta http-equiv="X-UA-Compatible" content="IE=edge"/>
	<meta name="viewport" content="width=device-width, initial-scale=1"/>
	<meta name="description" content="QUẢN LÝ - RAU SẠCH HỒNG THU"/>
		            ...
		            <table style="width: 100%;" class="vmk_table_form">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../Default.aspx" class="btn btn-primary btn-sm">TRANG CHỦ</a>
                            </td>
                        </tr>
                    </table>
	            </div>
