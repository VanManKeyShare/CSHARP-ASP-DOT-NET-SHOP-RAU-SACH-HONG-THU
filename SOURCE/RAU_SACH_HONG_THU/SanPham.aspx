<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
 CodeBehind="SanPham.aspx.cs" Inherits="RAU_SACH_HONG_THU.SanPham_TrangChu" %>
...
<div id="body">
	<div class="wrap-p clearfix" style="min-height: 300px; margin-top: 10px; word-wrap: break-word;">
        ...
        <asp:Panel ID="panel_nhieu_sanpham" runat="server" Visible="false">
            ...
            <h5 style="margin-bottom: 3px; color: white"><asp:Label ID="label_tendm" runat="server" Text="Không có dữ liệu"></asp:Label></h5>
